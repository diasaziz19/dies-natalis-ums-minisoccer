...
export const INITIAL_PLAYERS = [
  ...
  { id: 'p1-4', teamId: 'team-1', fullName: 'Kiper Utama Parkir', identityNumber: '3372010404980004', usia: 26, position: 'GOALKEEPER', photoProfileUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=KiperParkir' },
  ...
  { id: 'p1-8', teamId: 'team-1', fullName: 'Irfan Bachdim', identityNumber: '3372010808020008', usia: 22, position: 'FORWARD', photoProfileUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=IrfanParkir' },
  ...
  // Team 3: FKIP
  { id: 'p3-1', teamId: 'team-3', fullName: 'Andi Wijaya', identityNumber: '3372030101950001', usia: 28, position: 'GOALKEEPER', photoProfileUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=AndiFKIP' },
  { id: 'p3-2', teamId: 'team-3', fullName: 'Bima Sakti', identityNumber: '3372030202960002', usia: 27, position: 'DEFENDER', photoProfileUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=BimaFKIP' },
  { id: 'p3-3', teamId: 'team-3', fullName: 'Candra Wijaya', identityNumber: '3372030303970003', usia: 26, position: 'DEFENDER', photoProfileUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=CandraFKIP' },
  { id: 'p3-4', teamId: 'team-3', fullName: 'Dedi Kusnandar', identityNumber: '3372030404980004', usia: 25, position: 'MIDFIELDER', photoProfileUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=DediFKIP' },
  { id: 'p3-5', teamId: 'team-3', fullName: 'Evan Dimas', identityNumber: '3372030505990005', usia: 24, position: 'MIDFIELDER', photoProfileUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=EvanFKIP' },
  { id: 'p3-6', teamId: 'team-3', fullName: 'Febri Hariyadi', identityNumber: '3372030606000006', usia: 23, position: 'MIDFIELDER', photoProfileUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=FebriFKIP' },
  { id: 'p3-7', teamId: 'team-3', fullName: 'Guruh Soekarno', identityNumber: '3372030707010007', usia: 22, position: 'FORWARD', photoProfileUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=GuruhFKIP' },

  // Team 4: Geo + Hukum + LPIDB
  { id: 'p4-1', teamId: 'team-4', fullName: 'Hendra Setiawan', identityNumber: '3372040101950001', usia: 29, position: 'GOALKEEPER', photoProfileUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=HendraGH' },
  { id: 'p4-2', teamId: 'team-4', fullName: 'Irfan Jaya', identityNumber: '3372040202960002', usia: 28, position: 'DEFENDER', photoProfileUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=IrfanGH' },
  { id: 'p4-3', teamId: 'team-4', fullName: 'Jajang Sukmara', identityNumber: '3372040303970003', usia: 27, position: 'DEFENDER', photoProfileUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=JajangGH' },
  { id: 'p4-4', teamId: 'team-4', fullName: 'Kurnia Meiga', identityNumber: '3372040404980004', usia: 26, position: 'MIDFIELDER', photoProfileUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=KurniaGH' },
  { id: 'p4-5', teamId: 'team-4', fullName: 'Luthfi Kamal', identityNumber: '3372040505990005', usia: 25, position: 'MIDFIELDER', photoProfileUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=LuthfiGH' },
  { id: 'p4-6', teamId: 'team-4', fullName: 'Marc Klok', identityNumber: '3372040606000006', usia: 24, position: 'MIDFIELDER', photoProfileUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=KlokGH' },
  { id: 'p4-7', teamId: 'team-4', fullName: 'Nadeo Argawinata', identityNumber: '3372040707010007', usia: 23, position: 'FORWARD', photoProfileUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=NadeoGH' },

  // Team 5: FKI Teknik
  { id: 'p5-1', teamId: 'team-5', fullName: 'Oktovianus Maniani', identityNumber: '3372050101950001', usia: 29, position: 'GOALKEEPER', photoProfileUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=OktoFKIT' },
  { id: 'p5-2', teamId: 'team-5', fullName: 'Pratama Arhan', identityNumber: '3372050202960002', usia: 28, position: 'DEFENDER', photoProfileUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=ArhanFKIT' },
  { id: 'p5-3', teamId: 'team-5', fullName: 'Qischil Gandrum', identityNumber: '3372050303970003', usia: 27, position: 'DEFENDER', photoProfileUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=QischilFKIT' },
  { id: 'p5-4', teamId: 'team-5', fullName: 'Rachmat Irianto', identityNumber: '3372050404980004', usia: 26, position: 'MIDFIELDER', photoProfileUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=IriantoFKIT' },
  { id: 'p5-5', teamId: 'team-5', fullName: 'Saddil Ramdani', identityNumber: '3372050505990005', usia: 25, position: 'MIDFIELDER', photoProfileUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=SaddilFKIT' },
  { id: 'p5-6', teamId: 'team-5', fullName: 'Terens Puhiri', identityNumber: '3372050606000006', usia: 24, position: 'MIDFIELDER', photoProfileUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=TerensFKIT' },
  { id: 'p5-7', teamId: 'team-5', fullName: 'Utam Rusdiana', identityNumber: '3372050707010007', usia: 23, position: 'FORWARD', photoProfileUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=UtamFKIT' },

...
export const INITIAL_TEAMS = [
  { id: 'team-1', name: 'Pendidikan Olahraga (POR FKIP)', facultyUnit: 'Prodi Pendidikan Olahraga FKIP UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=PORFKIP&backgroundColor=ff6600', managerName: 'Dr. Nur Subekti, M.Or', managerPhone: '081234567801', status: 'APPROVED' },
  { id: 'team-2', name: 'Pendidikan Matematika FC', facultyUnit: 'Prodi Pendidikan Matematika FKIP UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=MATEMATIKAFKIP&backgroundColor=003366', managerName: 'Dr. Rita P Khotimah', managerPhone: '081234567802', status: 'APPROVED' },
  { id: 'team-3', name: 'Pendidikan Teknik Informatika (PTI)', facultyUnit: 'Prodi PTI FKIP UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=PTIFKIP&backgroundColor=0099cc', managerName: 'Aris Rakhmadi, M.Eng', managerPhone: '081234567803', status: 'APPROVED' },
  { id: 'team-4', name: 'DEE English Dept (PBI FKIP)', facultyUnit: 'Prodi Pendidikan Bahasa Inggris FKIP UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=DEEFKIP&backgroundColor=990033', managerName: 'Titis Setyabudi, M.Hum', managerPhone: '081234567804', status: 'APPROVED' },
  { id: 'team-5', name: 'Pendidikan Guru SD (PGSD FC)', facultyUnit: 'Prodi PGSD FKIP UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=PGSDFKIP&backgroundColor=009966', managerName: 'Anam Sutopo, M.Hum', managerPhone: '081234567805', status: 'APPROVED' },
  { id: 'team-6', name: 'Pendidikan Biologi FC', facultyUnit: 'Prodi Pendidikan Biologi FKIP UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=BIOLOGIFKIP&backgroundColor=339900', managerName: 'Dr. Triastuti Rahayu', managerPhone: '081234567806', status: 'APPROVED' },
  { id: 'team-7', name: 'Pendidikan Bahasa Indonesia (PBSI)', facultyUnit: 'Prodi PBSI FKIP UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=PBSIFKIP&backgroundColor=cc0099', managerName: 'Dr. Main Sufanti', managerPhone: '081234567807', status: 'APPROVED' },
  { id: 'team-8', name: 'Pendidikan Geografi FC', facultyUnit: 'Prodi Pendidikan Geografi FKIP UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=GEOGRAFIFKIP&backgroundColor=669900', managerName: 'Drs. Suharjo, M.Si', managerPhone: '081234567808', status: 'APPROVED' },
  { id: 'team-9', name: 'Pendidikan Akuntansi FC', facultyUnit: 'Prodi Pendidikan Akuntansi FKIP UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=AKUNTANSIFKIP&backgroundColor=006699', managerName: 'Dr. Suranto, ST, MM', managerPhone: '081234567809', status: 'APPROVED' },
  { id: 'team-10', name: 'PPKn Pancasila FC', facultyUnit: 'Prodi PPKn FKIP UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=PPKNFKIP&backgroundColor=cc0033', managerName: 'Dr. Yulia Maftuhah', managerPhone: '081234567810', status: 'APPROVED' },
  { id: 'team-11', name: 'PAUD Ceria FC (PAUD FKIP)', facultyUnit: 'Prodi Pendidikan PAUD FKIP UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=PAUDFKIP&backgroundColor=ff3399', managerName: 'Dra. Juninah, M.Pd', managerPhone: '081234567811', status: 'APPROVED' },
  { id: 'team-12', name: 'Unit Rektorat Star (Rektorat UMS)', facultyUnit: 'Unit Rektorat & Staf UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=REKTORATUMS&backgroundColor=6600cc', managerName: 'Drs. Sugeng Mulyono', managerPhone: '081234567812', status: 'APPROVED' },
  { id: 'team-13', name: 'Perpustakaan UMS FC', facultyUnit: 'Unit Perpustakaan Pusat UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=PERPUSUMS&backgroundColor=006666', managerName: 'Mustafa, S.IP, M.Hum', managerPhone: '081234567813', status: 'APPROVED' },
  { id: 'team-14', name: 'Unit IT & Pesma UMS', facultyUnit: 'LIT & Pesma KH Mas Mansur UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=PESMAUMS&backgroundColor=003399', managerName: 'Ir. Budi Santoso', managerPhone: '081234567814', status: 'APPROVED' },
  { id: 'team-15', name: 'Sarpras & Keamanan UMS', facultyUnit: 'Unit Keamanan & Sarpras UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=SARPRASUMS&backgroundColor=993300', managerName: 'Bambang Sukojo', managerPhone: '081234567815', status: 'APPROVED' },
  { id: 'team-16', name: 'Lab-School & Dekanat FKIP', facultyUnit: 'Laboratorium & Dekanat FKIP UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=LABFKIP&backgroundColor=00cc99', managerName: 'Prof. Dr. Sutama, M.Pd', managerPhone: '081234567816', status: 'APPROVED' }
];

// Player data: Nama, No. KTP/NI. Kepegawaian, Usia, Posisi (no jerseyNumber)

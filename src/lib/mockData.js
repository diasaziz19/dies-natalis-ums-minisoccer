...
export const INITIAL_TEAMS = [
  { id: 'team-1', name: 'Pendidikan Olahraga (POR FKIP)', facultyUnit: 'FKIP UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=PORFKIP&backgroundColor=ff6600', managerId: 'mgr-team-1', managerName: 'Bambang Supriyanto', managerPhone: '081234567801', status: 'APPROVED', suratTugasName: null },
  { id: 'team-2', name: 'Pendidikan Matematika FC', facultyUnit: 'FKIP UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=MATEMATIKAFKIP&backgroundColor=003366', managerId: 'mgr-team-2', managerName: 'Ahmad Dahlan', managerPhone: '081234567802', status: 'APPROVED', suratTugasName: null },
  { id: 'team-3', name: 'Pendidikan Teknik Informatika (PTI)', facultyUnit: 'FKIP UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=PTIFKIP&backgroundColor=0099cc', managerId: 'mgr-team-3', managerName: 'Dwi Cahyono', managerPhone: '081234567803', status: 'APPROVED', suratTugasName: null },
  { id: 'team-4', name: 'DEE English Dept (PBI FKIP)', facultyUnit: 'FKIP UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=DEEFKIP&backgroundColor=990033', managerId: 'mgr-team-4', managerName: 'Siti Rahmawati', managerPhone: '081234567804', status: 'APPROVED', suratTugasName: null },
  { id: 'team-5', name: 'Pendidikan Guru SD (PGSD FC)', facultyUnit: 'FKIP UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=PGSDFKIP&backgroundColor=009966', managerId: 'mgr-team-5', managerName: 'Eko Prasetyo', managerPhone: '081234567805', status: 'APPROVED', suratTugasName: null },
  { id: 'team-6', name: 'Pendidikan Biologi FC', facultyUnit: 'FKIP UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=BIOLOGIFKIP&backgroundColor=339900', managerId: 'mgr-team-6', managerName: 'Fitri Handayani', managerPhone: '081234567806', status: 'APPROVED', suratTugasName: null },
  { id: 'team-7', name: 'Pendidikan Bahasa Indonesia (PBSI)', facultyUnit: 'FKIP UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=PBSIFKIP&backgroundColor=cc0099', managerId: 'mgr-team-7', managerName: 'Hendra Setiawan', managerPhone: '081234567807', status: 'APPROVED', suratTugasName: null },
  { id: 'team-8', name: 'Pendidikan Geografi FC', facultyUnit: 'FKIP UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=GEOGRAFIFKIP&backgroundColor=669900', managerId: 'mgr-team-8', managerName: 'Indra Wijaya', managerPhone: '081234567808', status: 'APPROVED', suratTugasName: null },
  { id: 'team-9', name: 'Pendidikan Akuntansi FC', facultyUnit: 'FKIP UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=AKUNTANSIFKIP&backgroundColor=006699', managerId: 'mgr-team-9', managerName: 'Joko Susilo', managerPhone: '081234567809', status: 'APPROVED', suratTugasName: null },
  { id: 'team-10', name: 'PPKn Pancasila FC', facultyUnit: 'FKIP UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=PPKNFKIP&backgroundColor=cc0033', managerId: 'mgr-team-10', managerName: 'Kusuma Wardana', managerPhone: '081234567810', status: 'APPROVED', suratTugasName: null },
  { id: 'team-11', name: 'PAUD Ceria FC (PAUD FKIP)', facultyUnit: 'FKIP UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=PAUDFKIP&backgroundColor=ff3399', managerId: 'mgr-team-11', managerName: 'Lestari Putri', managerPhone: '081234567811', status: 'APPROVED', suratTugasName: null },
  { id: 'team-12', name: 'Unit Rektorat Star (Rektorat UMS)', facultyUnit: 'Unit UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=REKTORATUMS&backgroundColor=6600cc', managerId: 'mgr-team-12', managerName: 'Muhammad Arifin', managerPhone: '081234567812', status: 'APPROVED', suratTugasName: null },
  { id: 'team-13', name: 'Perpustakaan UMS FC', facultyUnit: 'Unit UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=PERPUSUMS&backgroundColor=006666', managerId: 'mgr-team-13', managerName: 'Nugroho Adi', managerPhone: '081234567813', status: 'APPROVED', suratTugasName: null },
  { id: 'team-14', name: 'Unit IT & Pesma UMS', facultyUnit: 'Unit UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=PESMAUMS&backgroundColor=003399', managerId: 'mgr-team-14', managerName: 'Oki Kurniawan', managerPhone: '081234567814', status: 'APPROVED', suratTugasName: null },
  { id: 'team-15', name: 'Sarpras & Keamanan UMS', facultyUnit: 'Unit UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=SARPRASUMS&backgroundColor=993300', managerId: 'mgr-team-15', managerName: 'Purnomo Shiddiq', managerPhone: '081234567815', status: 'APPROVED', suratTugasName: null },
  { id: 'team-16', name: 'Lab-School & Dekanat FKIP', facultyUnit: 'FKIP UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=LABFKIP&backgroundColor=00cc99', managerId: 'mgr-team-16', managerName: 'Qomaruddin Hidayat', managerPhone: '081234567816', status: 'APPROVED', suratTugasName: null }
];

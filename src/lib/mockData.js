...
export const INITIAL_TEAMS = [
  { id: 'team-1', name: 'SATPAM', facultyUnit: 'Unit Keamanan / Satpam UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=SATPAM&backgroundColor=003366', managerId: 'mgr-team-1', managerName: 'Ahmad Dahlan', managerPhone: '081234567801', status: 'APPROVED', suratTugasName: null },
  { id: 'team-2', name: 'PARKIR', facultyUnit: 'Unit Sarpras & Parkir UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=PARKIR&backgroundColor=ff6600', managerId: 'mgr-team-2', managerName: 'Bambang Supriyanto', managerPhone: '081234567802', status: 'APPROVED', suratTugasName: null },
  { id: 'team-3', name: 'FKIP', facultyUnit: 'Fakultas Keguruan & Ilmu Pendidikan', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=FKIP&backgroundColor=0099cc', managerId: 'mgr-team-3', managerName: 'Dwi Cahyono', managerPhone: '081234567803', status: 'APPROVED', suratTugasName: null },
  { id: 'team-4', name: 'FKI + FT + VOKASI', facultyUnit: 'Fakultas Komunikasi Informatika, Teknik & Vokasi', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=FKIFTVOKASI&backgroundColor=009966', managerId: 'mgr-team-4', managerName: 'Eko Prasetyo', managerPhone: '081234567804', status: 'APPROVED', suratTugasName: null },
  { id: 'team-5', name: 'FEB', facultyUnit: 'Fakultas Ekonomi & Bisnis UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=FEB&backgroundColor=6600cc', managerId: 'mgr-team-5', managerName: 'Muhammad Arifin', managerPhone: '081234567805', status: 'APPROVED', suratTugasName: null },
  { id: 'team-6', name: 'FG + FHIP + LBIPU', facultyUnit: 'Geografi, Hukum, Ilmu Pemerintahan & LBIPU', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=FGFHIPLBIPU&backgroundColor=990033', managerId: 'mgr-team-6', managerName: 'Siti Rahmawati', managerPhone: '081234567806', status: 'APPROVED', suratTugasName: null },
  { id: 'team-7', name: 'BPUI (AUM, AHAS, EDU, MMC & UNIT USAHA LAIN)', facultyUnit: 'Badan Pengelola Usaha & Inovasi (BPUI)', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=BPUIAUMAHASEDUMMCUNITUSAHALAIN&backgroundColor=00cc99', managerId: 'mgr-team-7', managerName: 'Qomaruddin Hidayat', managerPhone: '081234567807', status: 'APPROVED', suratTugasName: null },
  { id: 'team-8', name: 'PSIKOLOGI + PASCA + FARMASI', facultyUnit: 'Fakultas Psikologi, Pascasarjana & Farmasi', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=PSIKOLOGIPASCAFARMASI&backgroundColor=006699', managerId: 'mgr-team-8', managerName: 'Joko Susilo', managerPhone: '081234567808', status: 'APPROVED', suratTugasName: null },
  { id: 'team-9', name: 'RSGM + FKG', facultyUnit: 'RSGM & Fakultas Kedokteran Gigi UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=RSGMFKG&backgroundColor=cc0099', managerId: 'mgr-team-9', managerName: 'Hendra Setiawan', managerPhone: '081234567809', status: 'APPROVED', suratTugasName: null },
  { id: 'team-10', name: 'FIK', facultyUnit: 'Fakultas Ilmu Kesehatan UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=FIK&backgroundColor=cc0033', managerId: 'mgr-team-10', managerName: 'Kusuma Wardana', managerPhone: '081234567810', status: 'APPROVED', suratTugasName: null },
  ...
  { id: 'team-12', name: 'PERPUSTAKAAN + LPPIK', facultyUnit: 'Perpustakaan & LPPIK UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=PERPUSTAKAANLPPIK&backgroundColor=006666', managerId: 'mgr-team-12', managerName: 'Nugroho Adi', managerPhone: '081234567812', status: 'APPROVED', suratTugasName: null },
  { id: 'team-13', name: 'DKeu + SAI + DAA + DKPTI + LP3A + DSTI', facultyUnit: 'Direktorat Keuangan, SAI, DAA, DKPTI, LP3A & DSTI', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=DKeuSAIDAADKPTILP3ADSTI&backgroundColor=e65100', managerId: 'mgr-team-13', managerName: 'Rahmat Basuki', managerPhone: '081234567813', status: 'APPROVED', suratTugasName: null },
  { id: 'team-14', name: 'BPH + SEK.Univ/HUMAS + DAPEN + DSDMO + DRKUI + DRPPS + BPP + LPPIP', facultyUnit: 'BPH, Sekretariat Universitas, Humas & Lembaga Universitas', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=BPHSEKUnivHUMASDAPENDSDMODRKUIDRPPSBPPLPPIP&backgroundColor=003399', managerId: 'mgr-team-14', managerName: 'Oki Kurniawan', managerPhone: '081234567814', status: 'APPROVED', suratTugasName: null },
  { id: 'team-15', name: 'DASP + OUTSOURCING', facultyUnit: 'Direktorat Aset & Sarana Prasarana serta Outsourcing', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=DASPOUTSOURCING&backgroundColor=993300', managerId: 'mgr-team-15', managerName: 'Purnomo Shiddiq', managerPhone: '081234567815', status: 'APPROVED', suratTugasName: null },
  { id: 'team-16', name: 'PESMA + KEDOKTERAN UMUM', facultyUnit: 'Pesma & Fakultas Kedokteran Umum UMS', logoUrl: 'https://api.dicebear.com/7.x/identicon/svg?seed=PESMAKEDOKTERANUMUM&backgroundColor=339900', managerId: 'mgr-team-16', managerName: 'Fitri Handayani', managerPhone: '081234567816', status: 'APPROVED', suratTugasName: null }
];
...
export const INITIAL_MATCHES = [
  { id: 'm-1', matchNumber: 1, stage: 'ROUND_OF_16', homeTeamId: 'team-1', homeTeamName: 'SATPAM', homeTeamLogo: 'https://api.dicebear.com/7.x/identicon/svg?seed=SATPAM&backgroundColor=003366', awayTeamId: 'team-2', awayTeamName: 'PARKIR', awayTeamLogo: 'https://api.dicebear.com/7.x/identicon/svg?seed=PARKIR&backgroundColor=ff6600', homeScore: 0, awayScore: 0, pitchLocation: 'Lapangan A UMS Stadium', kickoffTime: 'Hari 1 (08:00 WIB)', matchDate: 'Sabtu, 14 Maret 2026', status: 'SCHEDULED', events: [], cards: [] },
  { id: 'm-2', matchNumber: 2, stage: 'ROUND_OF_16', homeTeamId: 'team-3', homeTeamName: 'FKIP', homeTeamLogo: 'https://api.dicebear.com/7.x/identicon/svg?seed=FKIP&backgroundColor=0099cc', awayTeamId: 'team-4', awayTeamName: 'FKI + FT + VOKASI', awayTeamLogo: 'https://api.dicebear.com/7.x/identicon/svg?seed=FKIFTVOKASI&backgroundColor=009966', homeScore: 0, awayScore: 0, pitchLocation: 'Lapangan B UMS Stadium', kickoffTime: 'Hari 1 (08:00 WIB)', matchDate: 'Sabtu, 14 Maret 2026', status: 'SCHEDULED', events: [], cards: [] },
  { id: 'm-3', matchNumber: 3, stage: 'ROUND_OF_16', homeTeamId: 'team-5', homeTeamName: 'FEB', homeTeamLogo: 'https://api.dicebear.com/7.x/identicon/svg?seed=FEB&backgroundColor=6600cc', awayTeamId: 'team-6', awayTeamName: 'FG + FHIP + LBIPU', awayTeamLogo: 'https://api.dicebear.com/7.x/identicon/svg?seed=FGFHIPLBIPU&backgroundColor=990033', homeScore: 0, awayScore: 0, pitchLocation: 'Lapangan A UMS Stadium', kickoffTime: 'Hari 1 (09:15 WIB)', matchDate: 'Sabtu, 14 Maret 2026', status: 'SCHEDULED', events: [], cards: [] },
  { id: 'm-4', matchNumber: 4, stage: 'ROUND_OF_16', homeTeamId: 'team-7', homeTeamName: 'BPUI (AUM, AHAS, EDU, MMC & UNIT USAHA LAIN)', homeTeamLogo: 'https://api.dicebear.com/7.x/identicon/svg?seed=BPUIAUMAHASEDUMMCUNITUSAHALAIN&backgroundColor=00cc99', awayTeamId: 'team-8', awayTeamName: 'PSIKOLOGI + PASCA + FARMASI', awayTeamLogo: 'https://api.dicebear.com/7.x/identicon/svg?seed=PSIKOLOGIPASCAFARMASI&backgroundColor=006699', homeScore: 0, awayScore: 0, pitchLocation: 'Lapangan B UMS Stadium', kickoffTime: 'Hari 1 (09:15 WIB)', matchDate: 'Sabtu, 14 Maret 2026', status: 'SCHEDULED', events: [], cards: [] },
  { id: 'm-5', matchNumber: 5, stage: 'ROUND_OF_16', homeTeamId: 'team-9', homeTeamName: 'RSGM + FKG', homeTeamLogo: 'https://api.dicebear.com/7.x/identicon/svg?seed=RSGMFKG&backgroundColor=cc0099', awayTeamId: 'team-10', awayTeamName: 'FIK', awayTeamLogo: 'https://api.dicebear.com/7.x/identicon/svg?seed=FIK&backgroundColor=cc0033', homeScore: 0, awayScore: 0, pitchLocation: 'Lapangan A UMS Stadium', kickoffTime: 'Hari 1 (14:00 WIB)', matchDate: 'Sabtu, 14 Maret 2026', status: 'SCHEDULED', events: [], cards: [] },
  { id: 'm-6', matchNumber: 6, stage: 'ROUND_OF_16', homeTeamId: 'team-11', homeTeamName: 'FAI + SOBRON', homeTeamLogo: 'https://api.dicebear.com/7.x/identicon/svg?seed=FAISOBRON&backgroundColor=ff3399', awayTeamId: 'team-12', awayTeamName: 'PERPUSTAKAAN + LPPIK', awayTeamLogo: 'https://api.dicebear.com/7.x/identicon/svg?seed=PERPUSTAKAANLPPIK&backgroundColor=006666', homeScore: 0, awayScore: 0, pitchLocation: 'Lapangan B UMS Stadium', kickoffTime: 'Hari 1 (14:00 WIB)', matchDate: 'Sabtu, 14 Maret 2026', status: 'SCHEDULED', events: [], cards: [] },
  { id: 'm-7', matchNumber: 7, stage: 'ROUND_OF_16', homeTeamId: 'team-13', homeTeamName: 'DKeu + SAI + DAA + DKPTI + LP3A + DSTI', homeTeamLogo: 'https://api.dicebear.com/7.x/identicon/svg?seed=DKeuSAIDAADKPTILP3ADSTI&backgroundColor=e65100', awayTeamId: 'team-14', awayTeamName: 'BPH + SEK.Univ/HUMAS + DAPEN + DSDMO + DRKUI + DRPPS + BPP + LPPIP', awayTeamLogo: 'https://api.dicebear.com/7.x/identicon/svg?seed=BPHSEKUnivHUMASDAPENDSDMODRKUIDRPPSBPPLPPIP&backgroundColor=003399', homeScore: 0, awayScore: 0, pitchLocation: 'Lapangan A UMS Stadium', kickoffTime: 'Hari 1 (15:30 WIB)', matchDate: 'Sabtu, 14 Maret 2026', status: 'SCHEDULED', events: [], cards: [] },
  { id: 'm-8', matchNumber: 8, stage: 'ROUND_OF_16', homeTeamId: 'team-15', homeTeamName: 'DASP + OUTSOURCING', homeTeamLogo: 'https://api.dicebear.com/7.x/identicon/svg?seed=DASPOUTSOURCING&backgroundColor=993300', awayTeamId: 'team-16', awayTeamName: 'PESMA + KEDOKTERAN UMUM', awayTeamLogo: 'https://api.dicebear.com/7.x/identicon/svg?seed=PESMAKEDOKTERANUMUM&backgroundColor=339900', homeScore: 0, awayScore: 0, pitchLocation: 'Lapangan B UMS Stadium', kickoffTime: 'Hari 1 (15:30 WIB)', matchDate: 'Sabtu, 14 Maret 2026', status: 'SCHEDULED', events: [], cards: [] },
